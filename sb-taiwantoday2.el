;;; sb-taiwantoday2.el --- shimbun backend for taiwantoday.tw -*- coding: iso-2022-7bit; -*-
...
(luna-define-class shimbun-taiwantoday2
		   (shimbun-japanese-newspaper shimbun-text) ())

(defvar shimbun-taiwantoday2-top-level-domain "taiwantoday.tw"
  "Name of the top level domain for the Digital taiwantoday.")

(defvar shimbun-taiwantoday2-url
  (concat "http://" shimbun-taiwantoday2-top-level-domain)
  "Name of the parent url.")

(defvar shimbun-taiwantoday2-group-table
  (let* ((s0 "[\t\n ]*")
	 (s1 "[\t\n ]+")
	 (default
	   (list
...
;; (defvar shimbun-taiwantoday2-content-start "\n[\t\n ]*<!!--bodystart-->\n")
(defvar shimbun-taiwantoday2-content-start "<div[\t\n ]class=\"article\"[\t\n ]id=\"news_content\"><p>")
;; (defvar shimbun-taiwantoday2-content-end  "\n[\t\n ]*<!!--bodyend-->\n")
(defvar shimbun-taiwantoday2-content-end  "</div><!--#credit-->")
(defvar shimbun-taiwantoday2-x-face-alist nil)

(defvar shimbun-taiwantoday2-expiration-days 7)

(luna-define-method initialize-instance :after ((shimbun shimbun-taiwantoday2)
						 &rest init-args)
  (shimbun-set-server-name-internal shimbun "台湾")
  (shimbun-set-from-address-internal shimbun
				     (concat "webmaster@www."
					     shimbun-taiwantoday2-top-level-domain))
  ;; To share class variables between `shimbun-taiwantoday2' and its
  ;; successor `shimbun-taiwantoday2-html'.
  (shimbun-set-x-face-alist-internal shimbun shimbun-taiwantoday2-x-face-alist)
  (shimbun-set-expiration-days-internal shimbun
					shimbun-taiwantoday2-expiration-days)
  shimbun)

(luna-define-method shimbun-groups ((shimbun shimbun-taiwantoday2))
  (mapcar 'car shimbun-taiwantoday2-group-table))

(luna-define-method shimbun-current-group-name ((shimbun shimbun-taiwantoday2))
  (nth 1 (assoc (shimbun-current-group-internal shimbun)
		shimbun-taiwantoday2-group-table)))

(luna-define-method shimbun-index-url ((shimbun shimbun-taiwantoday2))
  (let ((group (shimbun-current-group-internal shimbun)))
    (concat shimbun-taiwantoday2-url "/"
	    (nth 2 (assoc group shimbun-taiwantoday2-group-table)))))

(defmacro shimbun-taiwantoday2-japanese-string-to-number (string)
...
(defun shimbun-taiwantoday2-shorten-brackets-in-string (string)
...
(defun shimbun-taiwantoday2-get-headers (shimbun)
  "Return a list of headers."
  (let ((group (shimbun-current-group-internal shimbun))
	(from (shimbun-from-address shimbun))
	(case-fold-search t)
	regexp numbers cyear cmonth month year day headers)
    (setq regexp (assoc group shimbun-taiwantoday2-group-table)
    ...
    (while (re-search-forward regexp nil t)
      (setq month (cond ((nth 3 numbers)
			...
			((nth 6 numbers)
			 (shimbun-taiwantoday2-japanese-string-to-number
      ...
      (push (shimbun-make-header
		 ...
		 (shimbun-mime-encode-string
		  (format "%02d/%02d %s"
			  month day
			  (shimbun-taiwantoday2-shorten-brackets-in-string
	     ...
	     "" 0 0
	     ;; xref
	     (concat shimbun-taiwantoday2-url "/" (match-string (nth 0 numbers))))
	    headers))
    headers))

(luna-define-method shimbun-get-headers ((shimbun shimbun-taiwantoday2)
					 &optional range)
  (shimbun-taiwantoday2-get-headers shimbun))

(defun shimbun-taiwantoday2-adjust-date-header (shimbun header)
...
(luna-define-method shimbun-make-contents :before ((shimbun shimbun-taiwantoday2)
						   header)
  (shimbun-taiwantoday2-adjust-date-header shimbun header))

(provide 'sb-taiwantoday2)

;;; sb-taiwantoday2.el ends here
