...
(defvar shimbun-epoch-top-level-domain "epochtimes.jp"
  "Name of the top level domain for the 大紀元.")
	 ...
	 (default
	   (list
	    (concat
	     ...
	     s0 "</font>")
	    1 4 4 2 5 8 9 nil)))
    `(("hodo" "時事報道" "ssbd.php" ,@default)
      ("hyoron" "時事評論" "sspl.html" ,@default)
      ("economic" "経済" "jingji.html" ,@default)
      ("china" "中国" "tszg.html" ,@default)
      ("culture" "文化" "whjy.html" ,@default)
      ("science" "自然・科学" "kexue.html" ,@default)
      ))
